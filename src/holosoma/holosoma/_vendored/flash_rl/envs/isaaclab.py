...
class IsaacLabVectorEnv(
    ...
    def __init__(
        ...
        # Holosoma vendoring patch: explicitly import isaaclab_tasks to ensure
        # gymnasium task IDs (Isaac-Velocity-Flat-G1-v0, ...) are registered
        # before parse_env_cfg is called. Upstream FlashSAC relies on this side
        # effect being triggered transitively, which is fragile across IsaacLab
        # versions.
