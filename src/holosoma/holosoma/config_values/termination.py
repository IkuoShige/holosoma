...
from holosoma.config_values.loco.k1.termination import k1_22dof_agile_termination, k1_22dof_termination
...
DEFAULTS = {
    ...
    "k1_22dof": k1_22dof_termination,
    "k1_22dof_agile": k1_22dof_agile_termination,
