...
from holosoma.config_values.loco.k1.randomization import (
    k1_22dof_agile_randomization,
    k1_22dof_randomization,
    k1_22dof_soccer_randomization,
)
...
DEFAULTS = {
    ...
    "k1_22dof": k1_22dof_randomization,
    "k1_22dof_agile": k1_22dof_agile_randomization,
    "k1_22dof_soccer": k1_22dof_soccer_randomization,
