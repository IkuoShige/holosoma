...
k1_22dof_agile_randomization = RandomizationManagerCfg(
    setup_terms={
        "push_randomizer_state": RandomizationTermCfg(
            func="holosoma.managers.randomization.terms.locomotion:PushRandomizerState",
            params={
                "push_interval_s": [3, 7],
                "max_push_vel": [2.0, 1.5],
                "enabled": True,
            },
        ),
        "setup_action_delay_buffers": RandomizationTermCfg(
        ...
        "randomize_base_com_startup": RandomizationTermCfg(
            func="holosoma.managers.randomization.terms.locomotion:randomize_base_com_startup",
            params={
                "base_com_range": {"x": [-0.03, 0.03], "y": [-0.03, 0.03], "z": [-0.03, 0.03]},
                "enabled": True,
            },
        ),
    },
...
k1_22dof_soccer_randomization = RandomizationManagerCfg(
    setup_terms={
        "push_randomizer_state": RandomizationTermCfg(
            func="holosoma.managers.randomization.terms.locomotion:PushRandomizerState",
            params={
        ...
        "randomize_base_com_startup": RandomizationTermCfg(
            func="holosoma.managers.randomization.terms.locomotion:randomize_base_com_startup",
            params={
                "base_com_range": {"x": [-0.02, 0.02], "y": [-0.02, 0.02], "z": [-0.02, 0.02]},
                "enabled": True,
            },
        ),
    },
...
__all__ = ["k1_22dof_agile_randomization", "k1_22dof_randomization", "k1_22dof_soccer_randomization"]
