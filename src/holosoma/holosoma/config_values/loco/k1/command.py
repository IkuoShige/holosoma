...
k1_22dof_soccer_command = CommandManagerCfg(
    ...
    setup_terms={
        "locomotion_gait": CommandTermCfg(
            func="holosoma.managers.command.terms.locomotion:LocomotionGait",
            params={
                # Base cadence ~2.22 Hz (faster than feat/k1's 1.82 Hz); scales to ~3.0 Hz at 1.5 m/s.
                "gait_period": 0.45,
        ...
        "locomotion_command": CommandTermCfg(
            ...
            params={
                ...
                "stand_prob": 0.15,
                # Diverse combined motions for jerky cmd_vel robustness (soccer scenarios).
                "combined_motion_prob": 0.35,
                "combined_lin_vel_x_range": [0.8, 1.5],
...
__all__ = ["k1_22dof_agile_command", "k1_22dof_command", "k1_22dof_soccer_command"]
