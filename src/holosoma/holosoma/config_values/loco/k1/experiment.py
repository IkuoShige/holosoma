...
k1_22dof_soccer_run = ExperimentConfig(
    env_class="holosoma.envs.locomotion.locomotion_manager.LeggedRobotLocomotionManager",
    training=TrainingConfig(project="hv-k1-manager", name="k1_22dof_soccer_run_manager"),
    algo=replace(algo.ppo, config=replace(algo.ppo.config, num_learning_iterations=35000, use_symmetry=True)),
    simulator=simulator.isaacsim,
    robot=robot.k1_22dof,
    terrain=terrain.terrain_locomotion_mix,
    ...
    termination=termination.k1_22dof_agile_termination,
    randomization=randomization.k1_22dof_soccer_randomization,
    command=command.k1_22dof_soccer_run_command,
    curriculum=curriculum.k1_22dof_soccer_run_curriculum,
    reward=reward.k1_22dof_soccer_run_loco,
    nightly=NightlyConfig(
        iterations=15000,
        metrics={"Episode/rew_tracking_ang_vel": [0.70, "inf"], "Episode/rew_tracking_lin_vel": [0.75, "inf"]},
    ),
)
